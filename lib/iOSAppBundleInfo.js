...
(function() {
  ...
  iOSAppBundleInfo = (function(superClass) {
    ...
    function iOSAppBundleInfo(filePathOrStream) {
      iOSAppBundleInfo.__super__.constructor.call(this, filePathOrStream);
    ...
    iOSAppBundleInfo.prototype._loadFileInfo = function(callback) {
      ...
      return this._findFileStream(/^Payload\/[^\/]+\.app\/Info.plist$/, (function(_this) {
    ...
    iOSAppBundleInfo.prototype.getIconFile = function(callback) {
      return this._findFileStream(/^Payload\/[^\/]+\.app\/AppIcon60x60@.*\.png$/, callback);
    };
