...
(function() {
  ...
  AndroidAppBundleInfo = (function(superClass) {
    ...
    function AndroidAppBundleInfo(filePathOrStream) {
      AndroidAppBundleInfo.__super__.constructor.call(this, filePathOrStream);
    ...
    AndroidAppBundleInfo.prototype._loadFileInfo = function(callback) {
      ...
      return this._findFileStream(/^AndroidManifest.xml$/, (function(_this) {
    ...
    AndroidAppBundleInfo.prototype.getIconFile = function(callback) {
      return this._findFileStream(/^drawable-*\/ic_launcher.png$/, callback);
    };
