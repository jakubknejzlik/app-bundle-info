...
(function() {
  ...
  AndroidAppBundleInfo = (function(superClass) {
    ...
    AndroidAppBundleInfo.prototype.getIconFile = function(callback) {
      var _this = this;
      return this.findFileStream('**/mipmap-*/ic_launcher.png', function(err, datas) {
        return err ? _this.findFileStream("**/drawable-*/ic_launcher.png", callback) : callback(err, datas);
      });
    };
